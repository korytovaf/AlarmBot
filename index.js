  ...
  try {
    ...
    setInterval(async () => {
      ...
      alarms.map( async (alarm) => {
        console.log('11111', new Date(+alarm.expiryTime))
        console.log('22222', new Date(currentDate.getTime() + currentDate.getTimezoneOffset()*60*1000 + currentDate.getTimezoneOffset()*60*1000))
        if (+alarm.expiryTime < currentDate.getTime() + currentDate.getTimezoneOffset()*60*1000 + currentDate.getTimezoneOffset()*60*1000) {
